...
class RegisterView(APIView):
    ...
    Args:
        APIView (): Apiview for handling get and post requests of RegisterView
    ...
    def post(self, request):
        """ will execute of /register post call
        """        
...
class LogoutView(APIView):
    ...
    Args:
        APIView (): Apiview for handling get and post requests of LogoutView

    """   
    permission_classes = [AllowAny]
    
    def get(self, request):
        """ will execute of /logout get call
        """
        logout(request)
        return redirect('user-login')
...
class AdminDash(APIView):
    ...
    Args:
        APIView (): Apiview for handling get and post requests of AdminDash view
    ...
    def get(self, request):
        """ will execute of /admin-dash get call
        """
    ...
    def post(self, request):
        """ will execute of /admin-dash post call
        """        
...
class LoginView(APIView):
    ...
    def post(self, request):
        """ will execute of /login post call
        """
...
class SearchView(APIView):
    ...
    def get(self, request):
        """ will execute of /searches get call
        """
...
class NewsView(APIView):
    ...
    def post(self, request):
        """ will execute of /news post call
        """
